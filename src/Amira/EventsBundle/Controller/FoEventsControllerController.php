...
class FoEventsControllerController extends Controller
{
    public function AjouterAction(Request $request)
    {
        ...
        return $this->render('AmiraEventsBundle:FoEventsController:ajouter.html.twig', array('fajout'=>$form->createView()));
    ...
    public function ModifierAction(Request $request)
    {
        ...
        return $this->render('AmiraEventsBundle:FoEventsController:modifier.html.twig', array('fmodif'=>$form->createView()));
    }
    ...
    public function DeleteAction($entite)
    {
        ...
        $em->remove($even);
        $em->flush();
        return $this->redirectToRoute('_folisting');
